chmod +x Nova-Installer.x86_64 #autorise AppV7.x86_64 à être éxécuté en double clique

sudo cp -i Nova-Installer.x86_64 ~/.local/bin #bouge AppV7.x86_64 dans /home/$USER/.local/bin (pour que le .desktop trouve super vite et universelement)
