...
# Installe Chocolatey
def install_choco():
    messagebox.showinfo("Installation", "Chocolatey n'est pas installé. Installation en cours...")
    subprocess.run([
    ...
    messagebox.showinfo("Succès", "Chocolatey installé. Vous pouvez maintenant installer des applications.")
...
def install_selected_apps():
    ...
    messagebox.showinfo("Terminé", "Toutes les applications ont été installées.")
